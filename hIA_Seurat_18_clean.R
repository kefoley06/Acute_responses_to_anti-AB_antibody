...
VlnPlot(hIA_data, features = c("nFeature_RNA"), ncol = 1, pt.size = 0)&geom_hline(yintercept = 200)&geom_hline(yintercept = 5000)
VlnPlot(hIA_data, features = c("nCount_RNA"), ncol = 1, pt.size = 0)
VlnPlot(hIA_data, features = c("percent.mt"), ncol = 1, pt.size = 0)&geom_hline(yintercept = 5)
...
#assign Timepoint1
hIA$Timepoint1<-substr(hIA$whole.ident,16,20)
head(hIA$Timepoint)
tail(hIA$Timepoint)
hIA$Timepoint1[hIA$Timepoint1 == "3day"]<- '3day'
hIA$Timepoint1[hIA$Timepoint1 == "_3day"]<- '3day'
hIA$Timepoint1[hIA$Timepoint1 == "24hr"]<- '24hr'
hIA$Timepoint1[hIA$Timepoint1 == "_24hr"]<- '24hr'
head(hIA$Timepoint1)
tail(hIA$Timepoint1)
...
DimPlot_scCustom(hIA, reduction = "umap", label = T, label.box = T, split.by = "Timepoint1", ncol = 2, colors_use = color_pal)
DimPlot_scCustom(hIA, reduction = "umap", label = T, label.box = T, split.by = "Sex", ncol = 2, colors_use = color_pal)
DimPlot_scCustom(hIA, reduction = "umap", label = T, label.box = T, split.by = "Injection", ncol = 2, colors_use = color_pal)
DimPlot_scCustom(hIA, reduction = "umap", label = F, label.box = F, split.by = "hIA_ID", num_columns = 3, colors_use = color_pal)
...
## 12. Adding Module scores ---------------------------------------------
  ...
  #Keren-Shaul, H., et al. (2017). "A Unique Microglia Type Associated with Restricting Development of Alzheimer’s Disease." Cell 169(7): 1276-1290.e1217.
  ...
  #Mathys - Cluster 3
  #Mathys, H., et al. (2017). "Temporal Tracking of Microglia Activation in Neurodegeneration at Single-Cell Resolution." Cell Reports 21(2): 366-380.
  ...
  #Hammond, T. R., et al. (2019). "Single-Cell RNA Sequencing of Microglia throughout the Mouse Lifespan and in the Injured Brain Reveals Complex Cell-State Changes." Immunity 50(1): 253-271.e256.
...
# Violin plot by cluster and gene marker 
  ...
  #Marsh, S. E., et al. (2022). "Dissection of artifactual and confounding glial signatures by single-cell sequencing of mouse and human brain." Nat Neurosci 25(3): 306-316.
  ...
  #Yang, H. S., et al. (2021). "Natural genetic variation determines microglia heterogeneity in wild-derived mouse models of Alzheimer's disease." Cell Rep 34(6): 108739.
